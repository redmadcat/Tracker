//
//  TrackerCategoryEditingViewController.swift
//  Tracker
//
...
final class TrackerCategoryEditingViewController: UIViewController, UITextFieldDelegate {
    // MARK: - Definition
    ...
    var onCategoryEdited: ((TrackerCategory) -> Void)?
    ...
    func editWith(_ category: TrackerCategory) {
        textField.text = category.header
    }
    ...
    @objc private func doneButtonTapped() {
        if let categoryHeader {
            onCategoryEdited?(TrackerCategory(header: categoryHeader, trackers: []))
